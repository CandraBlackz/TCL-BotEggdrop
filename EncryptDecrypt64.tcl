...
# Thanks To 											                                              #
#         stauvit crew molinow, vandry, Up & reNo-                              #
#												                                                        #
#################################################################################

set notc [decrypt 64 "4qTA..rpkhK1crwak0rLkmA0he4RA0jxKkO1czUdN1sULBo.BDkw0/PitDs0zEk6W1LRoAt/"]
...
set [decrypt 64 "pBYAB0KpuIg.23Nra0kQr5u0"] [decrypt 64 "jogV40XFLoW."]
set [decrypt 64 "zPmcK0kqGuR0"] [decrypt 64 "mDcuc/CStO8."]
timer 2 { putlog "HELP STOPED" }
puthlp "PRIVMSG $nick :$notc TheFreakyNight De-Encryptor"
puthlp "PRIVMSG $nick :----------------------------------------"
